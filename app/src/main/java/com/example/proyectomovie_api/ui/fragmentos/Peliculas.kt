...
class Peliculas : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.topRatedMovies("3fc6d274dd2c1c8f102b25412728f319").observe(viewLifecycleOwner){pelicula ->
            ...
            Glide.with(requireActivity()).load(baseUrl + pelicula[randomIndices[0]].posterPath).into(binding.imRatedPelicula1)
            Glide.with(requireActivity()).load(baseUrl + pelicula[randomIndices[1]].posterPath).into(binding.imRatedPelicula2)
            Glide.with(requireActivity()).load(baseUrl + pelicula[randomIndices[2]].posterPath).into(binding.imRatedPelicula3)
            Glide.with(requireActivity()).load(baseUrl + pelicula[randomIndices[3]].posterPath).into(binding.imRatedPelicula4)
